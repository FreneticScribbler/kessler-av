...
from .constants import PROTOCOL_2K, SCHEME_TCP, SCHEME_SERIAL
from .url_parser import parse_url
from .media_switch import MediaSwitch

from .protocol2k import get_tcp_media_switch, get_serial_media_switch
...
def get_media_switch(
    ...
    """
    if url.startswith(SCHEME_SERIAL):
        return get_serial_media_switch(
                port=url[len(SCHEME_SERIAL):],
